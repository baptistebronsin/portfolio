...
export default function ProjectCard(props: Props) {
  const devStatus = !import.meta.env.DEV
    ? undefined
    : !props.project.data.isAvailable
      ? ProjectStatus.HIDDEN
      : props.project.data.publishedAt &&
          props.project.data.publishedAt > new Date()
        ? ProjectStatus.FOR_LATER
        : !props.project.data.isDisplayedOnHomepage
          ? ProjectStatus.NOT_HOME
          : undefined;
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3 justify-between h-full">
            ...
            <div className="flex flex-row justify-between gap-2 w-full">
              ...
              <div className="flex flex-col justify-between w-full">
                ...
                <div>
                  ...
                  props.project.data.type === "personal" ? (
                    <Badge
                      variant="outline"
                  ...
                  props.project.data.status === "archived" ? (
                    <Badge
                      variant="outline"
                      className="text-xs text-orange-400 border-orange-400/40 ml-2"
                    >
                    ...
                    <Badge
                      variant="outline"
                      className="text-xs text-green-600 border-green-600/40 ml-2"
                    >
                    ...
                    <Badge
                      variant="outline"
                      className="text-xs text-red-600 border-red-600/40 ml-2"
                    >
        ...
        <div>
          {props.project.data.contributors &&
            props.project.data.contributors.length > 3 && (
              <div className="flex -space-x-1 overflow-hidden">
                ...
                {props.project.data.contributors?.length > 10 && (
                  <div className="w-[32px] h-[32px] rounded-full bg-gray-200 relative flex items-center justify-center">
