---
title: "Polycount"
description: "Polycount is my first Javascript web application. It allows users to assign expenses to group activities (like Tricount)."
permalink: "polycount"
logo: '/images/project/polycount.png'
contributors:
  - baptiste_bronsin
publishedAt: 2025-01-01
# tags:
links:
  website: https://polycount.baptistebronsin.be
  gitlab: https://gitlab.com/baptiste.bronsin/polycount
status: archived
type: personnal
license: "AGPL-3.0"
isAvailable: false
